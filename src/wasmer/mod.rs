...
//! Defines structs and functions to utilize [wasmer](https://wasmer.io/) as smart contract execution environment.
//!
//! The state transition funcion executes contract in [Wasmer Environment](wasmer_env) after creation of
//! a [Wasmer Store](wasmer_store). The environment defines read-write access to [Wasmer Memory](wasmer_memory).
