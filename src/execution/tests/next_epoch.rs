...
// Commands (account a): Next Epoch
#[test]
fn test_next_epoch_single_pool_v2() {
    let fixture = TestFixture::new();
    let ws = {
        let mut state = create_state_v2(Some(fixture.ws()));
        setup_pool(
...
// Commands (account a): Next Epoch, Next Epoch
#[test]
fn test_next_epoch_single_pool_with_vp_v2() {
    let fixture = TestFixture::new();
    let ws = {
        let mut state = create_state_v2(Some(fixture.ws()));
        setup_pool(
...
// Commands (account a): Next Epoch, Next Epoch
#[test]
fn test_next_epoch_single_pool_auto_stake_v2() {
    let fixture = TestFixture::new();
    let ws = {
        let mut state = create_state_v2(Some(fixture.ws()));
        setup_pool(&mut state, ACCOUNT_A, 10_000, ACCOUNT_B, 90_000, true, true);
...
// Commands (account a): Next Epoch, Next Epoch
#[test]
fn test_next_epoch_multiple_pools_and_stakes_v2() {
    let fixture = TestFixture::new();
    let mut state = create_state_v2(Some(fixture.ws()));
...
// Commands (account a): Next Epoch, Next Epoch
#[test]
fn test_next_epoch_multiple_pools_and_stakes_auto_stake_v2() {
    let fixture = TestFixture::new();
    let mut state = create_state_v2(Some(fixture.ws()));
