...
pub trait ContractBinaryInterface<T> where T: wasmer::WasmerEnv + 'static {
...
pub(crate) mod blank {
    ...
    pub(crate) fn get(_: u32, _: u32, _: u32) -> i64 { 0 }
    pub(crate) fn get_network_storage(_: u32, _: u32, _: u32) -> i64 { 0 }
    pub(crate) fn balance() -> u64 { 0 }

    pub(crate) fn block_height() -> u64 { 0 }
    pub(crate) fn block_timestamp() -> u32 { 0 }
    pub(crate) fn prev_block_hash(_: u32) { }

    pub(crate) fn calling_account(_: u32) { }
    pub(crate) fn current_account(_: u32) { }
    pub(crate) fn method(_: u32) -> u32 { 0 }
    pub(crate) fn arguments(_: u32) -> u32 { 0 }
    pub(crate) fn amount() -> u64 { 0 }
    pub(crate) fn is_internal_call() -> i32 { 0 }
    pub(crate) fn transaction_hash(_: u32) { }
    
    pub(crate) fn call(_: u32, _: u32, _: u32) -> u32 { 0 }
